...
| Attraper un déchet | L’aspirateur doit être à la même position que le déchet lorsque le bouton est appuyé. | Une animation d’aspiration de l’aspirateur s’active et aspire le déchet, qui n’est plus visible. | Un bruit d'aspiration de l'aspirateur se joue jusqu’à la fin de l’animation de l'aspirateur. | Activation de l’animation d’aspiration et disparition d’un déchet. |
| Détection des objets déchets | Plus aucun déchet n’est détecté au fond de l’océan (sur le sol). | La couleur de l’océan devient plus claire et le nombre de poissons et créatures marines augmentent. | Changement de la musique d’ambiance pour une musique plus douce et joyeuse. | Fin de cycle – passage à la scène 3 |
