...
| Nom d'équipement   | Quantité |                           Fonction                           | Offert par le Programme |
| :----------------- | :------: | :----------------------------------------------------------: | ----------------------: |
| Manivelle          |    3     |        Manipulater la position des pinces virtuelles         |                     non |
| Bouton (interface) |    3     |          Manipulater l'action des pinces virtuelles          |                     non |
| Angle Unit         |    3     | Donner les données de la position de la manivelle vers unity |                     oui |
...
| PbHub              |    1     |        Connecter tous les éléments d'arduino ensemble        |                     oui |
